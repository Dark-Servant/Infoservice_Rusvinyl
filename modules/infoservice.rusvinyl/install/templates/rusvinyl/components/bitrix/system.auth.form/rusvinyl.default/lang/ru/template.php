...
$MESS['AUTH_SECURE_NOTE'] = 'Перед отправкой формы авторизации пароль будет зашифрован в браузере. '
                          . 'Это позволит избежать передачи пароля в открытом виде.';
$MESS['AUTH_NONSECURE_NOTE'] = 'Пароль будет отправлен в открытом виде. Включите JavaScript в браузере, '
                             . 'чтобы зашифровать пароль перед отправкой.';
